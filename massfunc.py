...
def do_snap(i,z,flist):
    ...
    for i in range(Nbins):
        print hist_x[i],numpy.log10(mf_theory_watson.M),numpy.log10(hist_y[i]),numpy.log10(mf_theory_watson.dndlog10m[i]),numpy.log10(mf_theory_behroozi.dndlog10m[i])
