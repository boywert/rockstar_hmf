...
def do_snap(i,z,flist):
    ...
    ax.plot(numpy.log10(mf_theory_watson.M),mf_theory_watson.dndlog10m/112.**3,label="Watson et al. (2012)")
    ax.plot(numpy.log10(mf_theory_behroozi.M),mf_theory_behroozi.dndlog10m/112.**3,label="Behroozi et al. (2012)")
    ax.set_yscale("log")
